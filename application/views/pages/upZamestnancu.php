...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE zamestnanec SET jmeno='$_POST[jmeno]',prijmeni='$_POST[prijmeni]',osobni_cislo='$_POST[osobni_cislo]' where id='$_POST[id]' ";
...
.vertical-center {
  ...
  right: 22%;
    ...
    <body>
        <center>
            <div class="box">
        <h1 style="color:#ffffff"> Úprava dat o zaměstnaních</h1>
        <form action="" method="POST">
            ...
            <div class="user-box">
            <input type="text" name="osobni_cislo" required=""/><br/>
